...
/**
 * Zod schema for creating an experience
...
/**
 * DTO interface for creating an experience
...
export class CreateExperienceRequestDto {
  ...
  @ApiPropertyOptional({ description: 'End date (YYYY-MM-DD), null for current role', example: '2022-12-31' })
  ...
  @ApiPropertyOptional({ description: 'Visibility status', default: true, example: true })
  is_visible?: boolean;
}
